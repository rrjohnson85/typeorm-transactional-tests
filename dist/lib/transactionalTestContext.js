...
var TransactionalTestContext = /** @class */ (function () {
    ...
    TransactionalTestContext.prototype.monkeyPatchQueryRunnerCreation = function (queryRunner) {
        ...
        typeorm_1.Connection.prototype.createQueryRunner = function () { return (__assign(__assign({}, queryRunner), { startTransaction: patch, commitTransaction: patch, rollbackTransaction: patch, release: patch })); };
    };
