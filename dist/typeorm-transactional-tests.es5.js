...
var TransactionalTestContext = /** @class */ (function () {
    ...
    TransactionalTestContext.prototype.monkeyPatchQueryRunnerCreation = function (queryRunner) {
        ...
        Connection.prototype.createQueryRunner = function () { return (__assign(__assign({}, queryRunner), { startTransaction: patch, commitTransaction: patch, rollbackTransaction: patch, release: patch })); };
    };
